...
```{r Survival and prepost plots (Fig. 4), eval = !figsEnd, fig.width = 8, fig.height = 7, fig.align = "center", fig.cap = "Choice consistency and stability in Experiment 1. A: Survival curve showing quit times within trial. B: Distribution of times when participants quit a trial over time. C: Proportion accepted in the second half as a function of first half acceptances. Dashed lines indicate the mean for each group. D: proportion accepted over time per group."}
...
# ggsave("./Images/FIG9_modelresults.png", modelPlot, device = "png", height = 8, width = 11)
