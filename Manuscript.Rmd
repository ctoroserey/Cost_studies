...
- Numbers on each chunk correspond generally to sections in the preregistrations
-->
...
$$\begin{aligned} 
g(*) = \dfrac {\sum p_i \text{R}_{i}} { 3\text{T}_\text{offer} + \sum p_i (\text{T}_\text{handling} + \text{T}_\text{reward}) + 3 \text{T}_\text{travel}},p \in \{0, 1\}
\end{aligned}$$
