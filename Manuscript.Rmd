...
The data obtained from human participants are available at https://github.com/ctoroserey/Cost_studies 

## Code availability

The code used to perform all analyses can be found in https://github.com/ctoroserey/Cost_studies
