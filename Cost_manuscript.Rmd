...
where $\gamma$ was the mean total earning rate per subject (mean = 0.55 cents per second, SD = 0.02). Negative values of $C_i$ would therefore suggest a boost in offer value produced by a demand. At each decision point, $C$ was the cost bias produced by each demand $c_\text{demand}$ weighted against a global bias estimate $c_\text{global}$
