...
\end{aligned}$$
  ...
  such that the handling time was counted only for accepted trials. These modifications allowed for the tracking of recent history that was part of our criteria, while mostly maintaining the same complexity (i.e. one free parameter) and structure of the base model
...
\end{aligned}$$
  ...
  In summary, the free parameters from the subjective time model captured three features. First, how fast or slow a given demand felt ($S_{demand}$). Second, whether and how fast this time sensitivity was recalibrated based on the experience of intermixed demands ($\alpha_w$). Finally, whether this time sensitivity was used retrospectively (i.e. high $\alpha$), or prospectively (i.e. low $\alpha$).
