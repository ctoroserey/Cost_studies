...
### Conclusion
  ...
  In this study, we have examined the factors that motivate the preference of different demands, emphasizing how these can be molded by the decision maker's environment. Unlike existing theories that have focused on the role of incentives and retrospectives [@Eisenberger1996; @Inzlicht2018], our work highlights outcome-independent features that can motivate the pursual of effortful avenues, and which can be potentially manipulated in order to promote engagement in clinical and daily activities.
