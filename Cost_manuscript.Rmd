...
\begin{align}
  \text{Model}_\text{biased} = R_i - (\gamma + mC_i) H_i
\end{align}
...
\begin{align}
  \text{Model}_\text{adaptive + biased} = R_i - (\gamma_i + mC_i) H_i
\end{align}
