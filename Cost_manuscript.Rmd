...
- We still think that cognitive and physical manipulations were effortful. Our physical effort task has been repeatedly used to probe effort []. Similar task switching has been shown to feel cognitively effortful by recruiting cognitive control (Kool, some amitai). Furthermore, the effortful nature of our manipulations is evidenced by the steeper decrease in acceptances over time at longer handling times (Treadway). There are many reasons why such cognitive manipulations can be effortful, which are often centered in the amount of control. Or the OC. 
- Efficacy, along with reward amount, can influence how much control is exherted. AFAIK, Eisenberger1982 provides evidence that task diversity motivates further effort engagement.
