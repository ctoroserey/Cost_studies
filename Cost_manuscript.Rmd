...
include_graphics("./Images/FIG1_task_a.png")
```
...
$$\begin{aligned} 
\dfrac {\sum p_i R_i} {Time_{offer} + (\sum p_i H + Time_{reward}) + 3T},p \in \{0, 1\}
\end{aligned}$$
...
include_graphics("./Images/FIG10_model.png")
