...
- Clinical: Te motivation to exert effort or wait for delays is a distinguishing factor among mental afflictions like depression and schizophrenia [@Barch2019]. Within the former, medicated patients in remission are more sensitive to effort than controls (and are not as motivated by rewards?), and this sensitivity is predictive of relapse [@Berwian2020]. Encouraging/increasing activities has been found to be a helpful treatment for depression [@Dimidjian2006]. Since depressed patients also show insensitivity to rewards [@Huys2013], identifying what makes effort appealing in its own right can help breach treatment-resistant cases. Our work suggests that subdividing a task can promote its pursual either by taxing working memory, counting, or simply distracting. Moreover, The concavity of value means that the motivating feeling of task completion would carry more weight as pieces rather than a big net amount (thaler). This should also hold practicality for everyday scenarios, like motivating exercise, work, etc.

, and motivational factors affecting effort aversion can be heterogenous between depression and schizophrenia

(https://link.springer.com/chapter/10.1007%2F978-3-030-27473-3_5). Like, the aversion is due to focusing on different elements of the task. Excessive aversion to delay and effort can manifest as impulsivity and apathy, respectively [1,10–12], fluctuations in which are hallmark symptoms of various mental illnesses and substance use disorders [13]. Our findings promote the idea that motivation to exhert effort can be boosted by chopping tasks into smaller digestible chunks that don't make them feel as long. Rather than telling them the final goal, keep them busy (this should be already a thing, I'm sure...). The concavity of value means that the motivating feeling of task completion would carry more weight as pieces rather than a big net amount (thaler). This should also hold practicality for everyday scenarios, like motivating exercise, work, etc.
