...
# # potential visualization, though difficult to interpret
# temp %>% 
#   filter(Cost != "Easy") %>%
#   select(Handling, Cost, Offer, significant) %>%
#   ggplot(aes(Cost, interaction(Offer, Handling), fill = significant)) +
