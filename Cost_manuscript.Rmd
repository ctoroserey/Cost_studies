...
- In this study....
  ...
  Evaluating whether to pursue a desired outcome often requires assessing the demands required for obtaining it. The intuitive reaction to this evaluation is aversion. In psychology and economics, demands for both time and effort have traditionally been identified as costs that detract from the net subjective value of rewards (Westbrook & Braver, 2015). Indeed, decision makers tend to prefer low-effort and immediate rewards over larger rewards that demand longer delays and higher effort (Ainslie, 1975; Hull, 1943; Kool & Botvinick, 2018; Kool, McGuire, Rosen, & Botvinick, 2010; Treadway, Buckholtz, Schwartzman, Lambert, & Zald, 2009; Westbrook, Kester, & Braver, 2013). However, people often change their attitudes towards exerting effort in everyday decisions, resulting in pursual of effortful avenues instead (Inzlicht, Shenhav, & Olivola, 2017). Much experimental and theoretical work surrounding the sporadic attractiveness of effort suggests a reciprocal relationship between effort and outcome, whereby exerting effort boosts the perceived value of its outcomes (kacelnik), and positive outcomes imbue value into their preceding effortful behavior (learned industriousness cite). Even though the prevalent emphasis on these retrospective value associations can help explain a variety of scenarios, it is still in its infancy (be more explicit).
  
  What is often missing from these accounts is the common case of choosing among behavioral demands, which is partly due to the scope of experimental designs. Studies tend to compare the reduction of subjective value imposed by each type of demand, often through discounting functions that capture how much less appealing a reward becomes as a function of the amount or intensity of its associated behavior [1,3,5,8,9,14]. Although this line of work suggests that discounting functions are similar for delay and effort [8,15,16], there is ongoing debate about the shape of the discounting function across effort types [2,8,11,17,18], and discount rates do not always correlate across cost domains [9,16]. Rather than arising from changes in the decay of value, flexible preferences for effort might stem from the availability of other types of demands in the same choice environment—in other words, from its context (Kool & Botvinick, 2018). For example, exerting high effort for a reward might be aversive, but the same level of work might become valuable when compared to the boredom of passive waiting. Now add charitable giving evidence from inzlicht paper. 
