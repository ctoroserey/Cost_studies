...
- Clinical: such deviations in the willingness to pursue effort can predict depression relapse (https://jamanetwork.com/journals/jamapsychiatry/article-abstract/2761562), and motivational factors affecting effort aversion can be heterogenous between depression and schizophrenia (https://www.researchgate.net/publication/337361164_Pathways_to_Motivational_Impairments_in_Psychopathology_Common_Versus_Unique_Elements_Across_Domains). Like, the aversion is due to focusing on different elements of the task. Excessive aversion to delay and effort can manifest as impulsivity and apathy, respectively [1,10–12], fluctuations in which are hallmark symptoms of various mental illnesses and substance use disorders [13]. Our findings promote the idea that motivation to exhert effort can be boosted by chopping tasks into smaller digestible chunks that don't make them feel as long. Rather than telling them the final goal, keep them busy (this should be already a thing, I'm sure...). The concavity of value means that the motivating feeling of task completion would carry more weight as pieces rather than a big net amount (thaler). This should also hold practicality for everyday scenarios, like motivating exercise, work, etc.
- Control/Exp Design: Having a between-subjects experiment provided a baseline of foraging behavior that helped us interpret the findings of the second experiment
- Control/Exp Design: for time as confound of effort
- Control/Exp Design: having two efforts helped dissociate domain-general from task-specific features.
- Control/Exp Design: participants were fully aware. This removed the possibility of asymmetric learning and choice difficulty. Demonstrated by stable strategies.
- Control/Exp Design: in demand experiments, chosen options are often carried out after the experiment, but there are known discrepancies between expected and obtained value that could affect repeated decisions in real life. Alt from grant: Investigations of the pursuit and receipt stages have been comparatively limited. Many studies have sought to isolate the evaluation stage by presenting subjects with choices whose results do not come into effect until the end of the experimental session (with delays spanning up to months), deliberately setting aside the question of how the ongoing experience of cost and outcome affects subsequent choices [5,11,15,16,19]. However, discrepancies between expected and experienced value are well known [20], and choosing immediate outcomes could be due to factors other than time preference, such as the risk of being unable to redeem the future rewards [3,21,22].
- Control/Exp Design: even in TAFC tasks, selecting the shorter option could index a wish to find a better set of options
- Control/Exp Design: Optimality let us know that people acted as if effort was attractive. This was evidenced by both the lower earnings by the cognitive effort group, and by the base OC model. Of note is that the optimality of the strategies produced by each cost depended on the richness of the block. This can help explain why the wait group earned the most despite having similar acceptance rates to the physical group, as the former was closer to optimality in the richest environment.
