...
\end{aligned}$$
  ...
  A third model considered the possibility that each type of demand biased the estimate of $\gamma$. Such bias would be stable if a single demand was experienced, but recalibrated into a global estimate as decision makers faced different types of demands. This dynamic could underlie the observed convergance of acceptances across demands. At each decision point, the bias produced by each demand ($c_{demand}$) was weighted against a global bias estimate $C$
  
$$\begin{aligned}
mC_i = c_{demand} w_i + C (1 - w_i)
\end{aligned}$$
